...
const val CONVERT_FROM = "%s cannot convert from %s."
const val CONVERT_TO = "'%s' is unable to convert '%s' to '%s'."
const val FAILED_BINDING = "Failed to convert configuration value at '%s' to type '%s'."